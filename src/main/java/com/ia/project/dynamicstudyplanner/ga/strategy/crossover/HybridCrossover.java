...
public class HybridCrossover implements CrossoverStrategy {
    ...
    public HybridCrossover(CrossoverStrategy exploitationStrategy, CrossoverStrategy explorationStrategy, double exploitationChance) {
        this.exploitationStrategy = exploitationStrategy;
        this.explorationStrategy = explorationStrategy;
        this.exploitationChance = exploitationChance;
    }
