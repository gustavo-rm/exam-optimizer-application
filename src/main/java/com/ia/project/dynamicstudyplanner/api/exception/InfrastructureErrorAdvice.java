...
/**
 * Falhas que não vêm do conteúdo da requisição nem de uma regra de negócio: segurança e a rede de
 * segurança do {@code 500}.
 *
 * <p>Os tratadores de limite de taxa, de fila cheia, de prazo esgotado e de Redis indisponível
 * saíram daqui junto com o caminho de concurso: o filtro de limite, o executor assíncrono e o
 * armazenamento compartilhado existiam para o endpoint síncrono e para o fluxo assíncrono daquele
 * caminho, e um tratador que nenhuma exceção alcança é código morto que aparenta cobertura.
 *
 ...
 * {@code WARN}; um {@code 500} é defeito nosso, e é exatamente o que um
